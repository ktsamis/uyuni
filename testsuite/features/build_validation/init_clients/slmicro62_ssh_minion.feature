...
Feature: Bootstrap a SL Micro 6.2 Salt SSH minion
  ...
  Scenario: Bootstrap a SL Micro 6.2 system managed via salt-ssh
    ...
    And I enter the hostname of "slmicro62_ssh_minion" as "hostname"
    And I enter "linux" as "password"
    And I select "1-slmicro62_ssh_minion_key" from "activationKeys"
...
@proxy
  Scenario: Check registration on proxy of SL Micro 6.2 SSH minion
    Given I am on the Systems overview page of this "proxy"
    When I follow "Details" in the content area
    And I follow "Proxy" in the content area
    Then I should see "slmicro62_ssh_minion" hostname

  Scenario: Check events history for failures on SL Micro 6.2 SSH minion
    Given I am on the Systems overview page of this "slmicro62_ssh_minion"
