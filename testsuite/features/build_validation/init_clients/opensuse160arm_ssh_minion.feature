...
Feature: Bootstrap a openSUSE 16.0 ARM Salt SSH minion
  ...
  Scenario: Bootstrap a openSUSE 16.0 ARM system managed via salt-ssh
    ...
    And I enter the hostname of "opensuse160arm_ssh_minion" as "hostname"
    And I enter "linux" as "password"
    And I select "1-opensuse160arm_ssh_minion_key" from "activationKeys"
    And I select the hostname of "proxy" from "proxies" if present
    And I click on "Bootstrap"
    And I wait until I see "Bootstrap process initiated." text
    And I wait until onboarding is completed for "opensuse160arm_ssh_minion"
...
@proxy
  Scenario: Check registration on proxy of openSUSE 16.0 ARM SSH minion
    ...
    Then I should see "opensuse160arm_ssh_minion" hostname
