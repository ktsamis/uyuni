...
Feature: Bootstrap a SLES 16.0 Salt SSH minion
  ...
  Scenario: Clean up sumaform leftovers on a SLES 16.0 Salt SSH minion
    When I perform a full salt minion cleanup on "sle160_ssh_minion"
  ...
  Scenario: Bootstrap a SLES 16.0 system managed via salt-ssh
    ...
    And I enter the hostname of "sle160_ssh_minion" as "hostname"
    And I enter "linux" as "password"
    And I select "1-sle160_ssh_minion_key" from "activationKeys"
    And I select the hostname of "proxy" from "proxies" if present
    And I click on "Bootstrap"
    And I wait until I see "Bootstrap process initiated." text
    And I wait until onboarding is completed for "sle160_ssh_minion"

@proxy
  Scenario: Check connection from SLES 16.0 SSH minion to proxy
    Given I am on the Systems overview page of this "sle160_ssh_minion"
...
@proxy
  Scenario: Check registration on proxy of SLES 16.0 SSH minion
    ...
    Then I should see "sle160_ssh_minion" hostname
